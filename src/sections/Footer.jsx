    ...
    <footer className="">
      <div className="pb-20">
        ...
        <div className="z-10 pt-[130px] relative">
          <div className="container items-center font-[Raleway] font-normal rounded-[40px] bg-gradient-to-tl from-[#050505] to-[#1C1C1C] p-[72px] border border-[#2B2B2B] block middle:flex justify-between">
            <div>
              <img src={Logo} alt="logo" />
              <p className="w-auto middle:w-[356px] opacity-80 text-[16px] mt-9">Ready to elevate your online presence? Contact us today to discuss your project and discover how we can bring your vision to life.</p>
            </div>
            <div>
              <div>
                <nav className="">
