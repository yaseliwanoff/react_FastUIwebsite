    ...
    <section className="container font-[Raleway] font-normal mt-[86px]">
      <div className="block large:flex items-end justify-between">
        <div className="w-full large:w-[387px]">
          ...
          <div className="mt-[81px] bg-gradient-to-tl from-[#050505] to-[#1C1C1C] p-[22px] border border-[#2B2B2B] rounded-[20px]">
            <h3 className="text-[20px] large:text-[35px] font-bold leading-[120%]">Let’s Schedule a Meeting</h3>
            <button className="w-[100%] bg-[#4E47FF] h-[60px] rounded-[10px] mt-[31px]">Schedule Meeting</button>
          </div>
        </div>
        <div className="w-full mt-5 large:w-[624px] h-auto bg-[#4E47FF] p-[22px] rounded-[20px]">
          <div className="p-[20px]">
            <h4 className="text-[20px] middle:text-[30px] font-bold leading-[120%]">Unlimited Services</h4>
            <p className="w-full large:w-[400px] mt-[21px] opacity-85">Take a look at some of our recent projects to see how we've helped businesses like yours succeed online.</p>
          ...
          <div className="p-[42px] bg-black rounded-[10px] w-[100%] h-[127px] items-center flex justify-between bottom-0">
            <div>
